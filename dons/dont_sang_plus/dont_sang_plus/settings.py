...
# If DB_NAME is provided via environment variables (decouple), use PostgreSQL.
# Otherwise fall back to a local SQLite DB for easy development/run.
...
if DB_NAME:
    ...
    # Development fallback: sqlite file inside the project
    DATABASES = {
        'default': {
